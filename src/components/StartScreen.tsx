  ...
  return (
    <div className="absolute inset-0 flex flex-col items-center justify-center z-20 bg-[#000010]/90">
      <div className="text-center px-4 max-w-lg">
        ...
        <p className="font-game-title text-lg md:text-xl text-[var(--game-orange)] mb-2 tracking-widest">
          Batalla de Metodologías TI
        </p>
        <p className="font-game-title text-sm md:text-base text-[var(--game-cyan)] mb-8 tracking-wide italic">
          ¿Sabes elegir la metodología correcta?
        </p>
        ...
        <div className="neon-border rounded-lg p-4 mb-8 bg-[#000020]/80 text-left font-game-body text-sm md:text-base text-[var(--game-text)]">
          ...
          <p className="mb-1">☄️ Destruye asteroides de metodología incorrecta</p>
          <p className="mb-1">🔵 Los asteroides azules activan preguntas de metodología</p>
          <p>🏆 ¡Sobrevive 3 minutos para ser experto en metodologías!</p>
        </div>
